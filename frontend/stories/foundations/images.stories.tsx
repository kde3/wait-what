...
const GROUPS: ImageGroup[] = [
  ...
  {
    title: '프로필 캐릭터 (카오스 7종)',
    description: 'ProfileAvatar가 무작위로 골라 쓰는 익명 프로필 이미지.',
    images: [
      { name: '404.png', path: '/images/characters/404.png' },
      { name: 'FILTER.png', path: '/images/characters/FILTER.png' },
      { name: 'GLITCH.png', path: '/images/characters/GLITCH.png' },
      { name: 'NULL.png', path: '/images/characters/NULL.png' },
      { name: 'PIXEL.png', path: '/images/characters/PIXEL.png' },
      { name: 'RETRY.png', path: '/images/characters/RETRY.png' },
      { name: 'TIMEOUT.png', path: '/images/characters/TIMEOUT.png' },
    ],
  },
  {
    title: '일러스트',
