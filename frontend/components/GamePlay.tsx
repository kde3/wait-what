      ...
      {g.submitted ? (
        ...
        <div className="rounded-xl border bg-surface p-5 text-foreground shadow-sm">
          {g.task.kind === 'phrase' && (
            <>
              <h2>{t('phraseTitle')}</h2>
              <p className="text-sm text-muted">{t('phraseHint')}</p>
              <Input
                type="text"
                maxLength={200}
          ...
          {g.task.kind === 'draw' && (
            <>
              <h2>{t('drawTitle')}</h2>
              <div className="rounded-lg border-l-4 border-accent bg-surface-secondary p-4 font-medium">“{g.task.sourceText}”</div>
